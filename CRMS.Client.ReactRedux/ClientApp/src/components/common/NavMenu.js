        ...
        return (
            <>
                <header className="head-itl navbar-fixed-top">
                    ...
                    {/*NAVBAR*/}
                    <Navbar className="m-t-b-auto navbar-expand-sm navbar-toggleable-sm navbar-light  navbar-itl-bg border-bottom box-shadow mb-3 fit-content-h">
                            ...
                            <ul className="navbar-nav flex-grow">
                                ...
                                <NavItem className="fit-content-w-h m-t-b-auto">
                                        <NavLink tag={Link} className="itl-nav-item-text" to="/"><FontAwesomeIcon className="fa-lg" icon={faHome} /><br/>FORSIDE</NavLink>
                                    </NavItem>

                                <NavItem className="fit-content-w-h m-t-b-auto">
                                    <NavLink tag={Link} className="itl-nav-item-text" to="/Customers"><FontAwesomeIcon className="fa-lg" icon={faUsers} /><br/>KUNDER</NavLink>
                                    </NavItem>

                                <NavItem className="fit-content-w-h m-t-b-auto">
                                    <NavLink tag={Link} className="itl-nav-item-text" to="/Products"><FontAwesomeIcon className="fa-lg" icon={faCubes} /><br/>PRODUKTER</NavLink>
                                    </NavItem>

                                <NavItem className="fit-content-w-h m-t-b-auto">
                                    <NavLink tag={Link} className="itl-nav-item-text " to="/Subscriptions"><FontAwesomeIcon className="fa-lg" icon={faBoxes} /><br/>ABONNEMENTER</NavLink>
                                    </NavItem>
                                ...
                                <NavItem className="fit-content-w-h m-t-b-auto">
                                    <NavLink tag={Link} className="itl-nav-item-text " to="/"><FontAwesomeIcon className="fa-lg" icon={faUserCircle} /><br/>{userState.email}</NavLink>
                                    </NavItem>


                                <NavItem className="fit-content-w-h m-t-b-auto">
                                        <NavLink tag={Link} className="itl-nav-item-text " to="/LogOut"><FontAwesomeIcon className="fa-lg" icon={faSignOutAlt} /><br/><span className="no-wrap">LOG UD</span></NavLink>
                                    </NavItem>
